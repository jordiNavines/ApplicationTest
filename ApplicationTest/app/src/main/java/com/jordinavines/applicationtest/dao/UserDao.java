...
public class UserDao {
    ...
    public static final String[] allColumns = {COLUMN_ID_USER, COLUMN_NAME, COLUMN_ABOUT, COLUMN_AVATAR, COLUMN_ADDRESS, COLUMN_EMAIL,COLUMN_DOB, COLUMN_DEPARTMENT, COLUMN_SUBORDINATES };
    ...
    public static User cursorToUser(Cursor cursor) {
        ...
        user.setDepartment(cursor.getString(7));
        //user.setSubordinates(cursor.getString(7));
        return user;
    }
